...
//size: VIRTUAL_COM_PORT_SIZ_CONFIG_DESC !!!!!
const uint8_t Virtual_Com_Port_ConfigDescriptor[] =
  {
    ...
    */
    ...
    USB_ENDPOINT_TYPE_BULK,//ISOCHRONOUS,   /* bmAttributes: Bulk */
    0x40,   /*USB_OUT_DATA_SIZE,             /* wMaxPacketSize: */
    0x00,
